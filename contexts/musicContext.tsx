...
const songs = [
  {
    ambient: '/sounds/music/01-ambient.ogg',
    artist: 'Tim Halbert',
    original: '/sounds/music/01.ogg',
    thud: '/sounds/music/01,10.ogg',
    title: 'Pink and Orange',
    website: 'https://www.timhalbert.com/',
  },
  {
    ambient: '/sounds/music/02-ambient.ogg',
    artist: 'Tim Halbert',
    original: '/sounds/music/02.ogg',
    thud: '/sounds/music/02.ogg',
    title: 'No Chance in Hell',
    website: 'https://www.timhalbert.com/',
  },
  {
    ambient: '/sounds/music/03-ambient.ogg',
    artist: 'Tim Halbert',
    original: '/sounds/music/03.ogg',
    thud: '/sounds/music/03.ogg',
    title: 'The Exchange',
    website: 'https://www.timhalbert.com/',
  },
  {
    ambient: '/sounds/music/04-ambient.ogg',
    artist: 'Tim Halbert',
    original: '/sounds/music/04.ogg',
    thud: '/sounds/music/04,07.ogg',
    title: 'Automaton',
    website: 'https://www.timhalbert.com/',
  },
  {
    ambient: '/sounds/music/05-ambient.ogg',
    artist: 'Tim Halbert',
    original: '/sounds/music/05.ogg',
    thud: '/sounds/music/05.ogg',
    title: 'Treason',
    website: 'https://www.timhalbert.com/',
  },
  {
    ambient: '/sounds/music/06-ambient.ogg',
    artist: 'Tim Halbert',
    original: '/sounds/music/06.ogg',
    thud: '/sounds/music/06.ogg',
    title: 'Insecticide',
    website: 'https://www.timhalbert.com/',
  },
  {
    ambient: '/sounds/music/07-ambient.ogg',
    artist: 'Tim Halbert',
    original: '/sounds/music/07.ogg',
    thud: '/sounds/music/04,07.ogg',
    title: 'Binary Shapes',
    website: 'https://www.timhalbert.com/',
  },
  {
    ambient: '/sounds/music/08-ambient.ogg',
    artist: 'Tim Halbert',
    original: '/sounds/music/08.ogg',
    thud: '/sounds/music/08,09.ogg',
    title: 'Peaceful Encounter',
    website: 'https://www.timhalbert.com/',
  },
  {
    ambient: '/sounds/music/09-ambient.ogg',
    artist: 'Tim Halbert',
    original: '/sounds/music/09.ogg',
    thud: '/sounds/music/08,09.ogg',
    title: 'Flatlander',
    website: 'https://www.timhalbert.com/',
  },
  {
    ambient: '/sounds/music/10-ambient.ogg',
    artist: 'Tim Halbert',
    original: '/sounds/music/10.ogg',
    thud: '/sounds/music/01,10.ogg',
    title: 'Anx',
    website: 'https://www.timhalbert.com/',
  },
