...
export const Games: Record<GameId, Game> = {
  [GameId.THINKY]: {
    ...
    stripePriceIdGiftYearly: process.env.STRIPE_THINKY_PRICE_ID_GIFT_YEARLY,
    stripePriceIdMonthly: process.env.STRIPE_THINKY_PRICE_ID_MONTHLY,
    stripePriceIdYearly: process.env.STRIPE_THINKY_PRICE_ID_YEARLY,
    isComplete: () => false,
  },
  [GameId.PATHOLOGY]: {
    id: GameId.PATHOLOGY,
