...
export default function validatePathobanSolution(directions: Direction[], level: Level) {
...
export function validatePathobanLevel(data: string): {valid: boolean, reasons: string[]} {
