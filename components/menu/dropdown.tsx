...
export default function Dropdown() {
  ...
  return (
    <div className='flex'>
      <div
        className='items-center float-left hidden sm:flex xl:hidden'
        style={{
              ...
              >
                {levelContext?.level &&
                  <div className='block sm:hidden'>
                    <Setting onClick={() => setOpenModal(Modal.LevelInfoDropdown)} icon={<svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' strokeWidth={1.5} stroke='currentColor' width='16' height='16'>
                      <path strokeLinecap='round' strokeLinejoin='round' d='M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12' />
                    </svg>}>
                      <button>
                        Level Info
                    ...
                    <Setting onClick={() => setOpenModal(Modal.ReviewsDropdown)} icon={<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='none' viewBox='0 0 24 24' stroke='currentColor' strokeWidth={2}>
                      <path strokeLinecap='round' strokeLinejoin='round' d='M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z' />
                    </svg>}>
                      <button>
                        Reviews
                ...
                {!userLoading && user && levelContext?.level && (
                  <>
                    <Setting onClick={() => setOpenModal(Modal.AddLevelToCollection)} icon={<svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' strokeWidth={1.5} stroke='currentColor' height='16' width='16'>
                ...
                <Setting onClick={() => setOpenModal(Modal.Theme)} icon={<svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' strokeWidth={1.5} stroke='currentColor' className='bi bi-plus' width='16' height='16'>
            ...
            {levelContext?.level &&
              <>
                <LevelInfoModal
                  ...
                  isOpen={openModal === Modal.LevelInfoDropdown}
                  level={levelContext.level}
                />
                <ReviewsModal
                  closeModal={() => closeModal()}
                  isOpen={openModal === Modal.ReviewsDropdown}
                />
              </>
            }
            <AddLevelModal
