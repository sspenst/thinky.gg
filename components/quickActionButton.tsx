...
export default function QuickActionButton({ href, icon, text, subtitle, disabled, className = '' }: QuickActionButtonProps) {
  const baseClasses = 'flex flex-col items-center justify-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg shadow-xs border border-gray-200 dark:border-gray-600 hover:shadow-md transition h-[100px] w-full';
