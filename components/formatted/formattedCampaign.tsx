...
export default function FormattedCampaign({
      ...
      levelOptions.push(
        <div className='relative flex items-center justify-center' key={`campaign-level-${level._id.toString()}`}>
          ...
          {index < filteredLevels.length - 1 && (
            <div className='absolute top-12 left-12 w-full h-0.5 bg-linear-to-r from-white/30 to-transparent z-0 transform rotate-12' />
          )}
      ...
      options.push(
        ...
        >
          ...
          <div className='relative max-w-4xl mx-auto'>
            ...
            {/* Main Island */}
            <div className={`relative bg-linear-to-br ${lockedStr
              ? 'from-gray-600 via-gray-700 to-gray-800'
              : 'from-emerald-400 via-teal-500 to-cyan-600'
            } rounded-t-4xl sm:rounded-t-[3rem] rounded-b-xl sm:rounded-b-2xl shadow-2xl overflow-hidden`}>

              {/* Mystical Aura */}
              <div className='absolute inset-0 bg-linear-to-t from-transparent via-white/10 to-white/20 animate-pulse' />
                ...
                <div className='relative z-10'>
                  ...
                  <div className='mb-4 sm:mb-6'>
                    <div className='inline-block transform -rotate-2'>
                      <div className='bg-linear-to-r from-yellow-400 to-orange-500 text-black font-black px-4 sm:px-6 py-2 sm:py-3 rounded-lg sm:rounded-xl shadow-lg text-lg sm:text-xl'>
              ...
              <div className='bg-linear-to-b from-white/10 to-white/5 backdrop-blur-xs p-4 sm:p-6 border-t border-white/20'>
                {lockedStr ? (
                  ...
                  <>
                    {!stats.isSolved() && (
                      <div className='mb-4 sm:mb-6 text-center'>
                        <div className='inline-block bg-black/30 backdrop-blur-xs text-white font-bold px-3 sm:px-4 py-1 sm:py-2 rounded-full border border-white/30'>
  ...
  return (<>
    ...
    <div className='relative bg-linear-to-b from-indigo-900 via-purple-900 to-slate-900 min-h-screen'>
      {/* Floating Islands Background */}
      <div className='absolute inset-0 opacity-30'>
        <div className='absolute top-10 left-10 w-40 h-20 bg-linear-to-r from-emerald-500 to-teal-500 rounded-full blur-xl animate-pulse' />
        <div className='absolute top-32 right-20 w-32 h-16 bg-linear-to-r from-pink-500 to-rose-500 rounded-full blur-xl animate-pulse' style={{ animationDelay: '1s' }} />
        <div className='absolute bottom-20 left-1/4 w-36 h-18 bg-linear-to-r from-yellow-500 to-orange-500 rounded-full blur-xl animate-pulse' style={{ animationDelay: '2s' }} />
      </div>

      {/* Chapter Overview */}
      <div className='relative z-10 text-center py-8 sm:py-16 px-4'>
        <div className='mb-6 sm:mb-8'>
          <div className='inline-block px-6 sm:px-8 py-2 sm:py-3 bg-linear-to-r from-yellow-400 to-orange-500 text-black font-black rounded-full text-lg sm:text-xl shadow-2xl mb-4 transform hover:scale-105 transition-all duration-300'>
            LEVEL SELECT
          </div>
        </div>

        {solvedLevels === totalLevels && (
          <div className='mb-8 sm:mb-12 p-6 sm:p-8 bg-linear-to-r from-green-400/20 to-emerald-500/20 border border-green-400/50 rounded-3xl backdrop-blur-xs max-w-2xl mx-auto'>
            ...
            {isCampaignComplete && nextTitle && nextHref && (
              <Link
                href={nextHref}
                className='inline-block bg-linear-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-black py-3 sm:py-4 px-6 sm:px-8 rounded-2xl shadow-2xl transform hover:scale-105 transition-all duration-300'
              >
        ...
        {solvedLevels > 0 && (
          <div className='mb-2 sm:mb-3'>
            <button
              ...
              className='group relative overflow-hidden bg-linear-to-r from-slate-700 to-slate-800 hover:from-slate-600 hover:to-slate-700 text-white font-bold py-3 px-4 sm:px-6 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300'
            >
              <div className='absolute inset-0 bg-linear-to-r from-white to-transparent opacity-10 transform skew-x-12 translate-x-full group-hover:-translate-x-full transition-transform duration-500' />
