        ...
        <div className='flex justify-center items-center h-full'>
          <div className='text-white transition-blur duration-75'>
            ...
            <div className='flex flex-col items-center mb-4'>
              <Link
                className='fadeIn inline-block px-6 py-1.5 mb-1 border-4 border-neutral-400 bg-white text-black font-bold text-5xl leading-snug rounded-xl hover:ring-4 ring-red-500/50 focus:ring-0 transition duration-100 ease-in-out'
                style={{
                  animationDelay: '0.5s',
                }}
