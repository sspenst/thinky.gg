...
export default function Home({
  ...
  const buttonsSection = <div className='flex flex-col items-center gap-2 max-w-full'>
    <div className='flex flex-row gap-2 w-fit'>
      ...
      <Link passHref href='/drafts' className={buttonClassNames}>
  ...
  const buttonsSections2 = <div className='flex justify-center m-6'>
