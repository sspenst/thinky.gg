  ...
  return (<>
    <Menu as='div' className='relative'>
      <Menu.Button className='flex items-center' id='dropdownMenuBtn' aria-label='dropdown menu'>
        <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' strokeWidth={1.5} stroke={user?._id.toString() === level.userId._id.toString() ? 'currentColor' : 'red'} className='w-6 h-6 hover:opacity-100 opacity-50'>
