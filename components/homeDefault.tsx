  ...
  return (
    <div className='sm:flex content-center my-6 mx-auto px-6 max-w-screen-2xl'>
      ...
      <div className='flex-auto sm:w-32 p-3'>
        ...
        <div className='text-left'>Join the <Link
          className={classNames('px-1 inline-flex justify-center items-center gap-2 rounded-md border font-medium align-middle focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-600 transition-all text-sm', discordClassNames)}
          href='https://discord.gg/NsN8SBEZGN'
          passHref
        >
