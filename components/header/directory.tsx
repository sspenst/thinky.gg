...
export default function Directory({ folders, subtitle, title }: DirectoryProps) {
  ...
  return (<>
    ...
    <div className='flex gap-2 items-center xl:hidden ml-4'>
      <button aria-label='Go back' className='hover:opacity-70 mr-1' onClick={router.back}>
        <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' strokeWidth={2} stroke='currentColor' className='w-5 h-5'>
          <path strokeLinecap='round' strokeLinejoin='round' d='M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18' />
        </svg>
      </button>
      <button aria-label='Go forward' className='hover:opacity-70' onClick={router.forward}>
        <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' strokeWidth={2} stroke='currentColor' className='w-5 h-5'>
