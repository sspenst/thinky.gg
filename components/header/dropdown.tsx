...
export default function Dropdown() {
  ...
  return (<>
    <div ref={dropdownRef} className='relative'>
      ...
      {isDropdownOpen && (
        <div
          className={`fixed right-0 m-1 w-fit origin-top-right rounded-[10px] shadow-lg border overflow-y-auto bg-1 border-color-3 transition-all duration-100 ${
        ...
        >
          <div className='px-1 py-1'>
            {user && <>
              ...
              <Link href={getProfileSlug(user)} passHref onClick={closeDropdown}>
            ...
            {user ?
              <>
                ...
                {game.hasPro &&
                  <Link href='/pro' passHref onClick={closeDropdown}>
                    <div
                      className='flex w-full items-center rounded-md cursor-pointer px-3 py-2 gap-3 hover-bg-3'
                    >
                ...
                <div
                  ...
                  onClick={() => {
                    closeDropdown();
                    isGuest(user) ? logOutToast() : logOut();
                  }}
                >
                  <svg xmlns='http://www.w3.org/2000/svg' className='w-5 h-5' fill='currentColor' viewBox='0 0 16 16'>
              ...
              <div className='block sm:hidden'>
                ...
                <Link href='/signup' onClick={closeDropdown}>
                  <div
                    className='flex w-full items-center rounded-md cursor-pointer px-3 py-2 gap-3 hover-bg-3'
                  >
                    <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' strokeWidth={1.5} stroke='currentColor' className='w-5 h-5'>
