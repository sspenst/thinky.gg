  ...
  return (
    <Page title='Ranked'>
      <div className='p-3 flex flex-col gap-6 items-center'>
        ...
        <p className='text-center max-w-xl'>Ranked levels are high quality puzzles curated by the Pathology community. Solving ranked levels is the best way to compete against other Pathology users and improve your spot on the leaderboard. New levels are periodically marked as ranked, so there is always a chance your levels could enter this curated list. Have fun!</p>
