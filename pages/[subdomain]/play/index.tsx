            ...
            <div className='relative bg-white/8 backdrop-blur-xl rounded-xl p-6 shadow-lg border border-white/20'>
              ...
              <div className='text-center text-sm text-white/80'>
                ...
                <div className='flex justify-center gap-4 mb-4'>
                  <div>
                    <div className='font-bold text-cyan-300'>50K+</div>
                    <div className='text-xs text-white/50'>Players</div>
                  </div>
                  <div>
                    <div className='font-bold text-green-300'>1M+</div>
                    <div className='text-xs text-white/50'>Levels Solved</div>
                  </div>
                </div>
                <button
                  onClick={() => window.location.href = '/api/auth/discord'}
                  className='inline-flex items-center gap-2 px-4 py-2 bg-white/12 backdrop-blur-md hover:bg-white/20 text-white rounded-lg transition-all duration-200 border border-white/25 hover:scale-105 transform'
                >
              ...
              <div className='relative bg-white/8 backdrop-blur-xl rounded-xl p-6 shadow-lg border border-white/20'>
                ...
                <div className='text-center text-sm text-white/80'>
                  ...
                  <div className='space-y-1'>
                    <div className='text-xs bg-white/10 backdrop-blur-sm rounded px-2 py-1 text-white/70'>Speed Solver</div>
                    <div className='text-xs bg-white/10 backdrop-blur-sm rounded px-2 py-1 text-white/70'>Perfect Path</div>
                    <div className='text-xs bg-white/10 backdrop-blur-sm rounded px-2 py-1 text-white/70'>Chapter Master</div>
                  </div>
                </div>
              </div>
            </div>
