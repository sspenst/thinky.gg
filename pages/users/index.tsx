...
export default function PlayersPage({ searchQuery, totalRows, users }: PlayersProps) {
  ...
  const columns = [
    ...
    },
    {
      ...
      format: row => getProfileRatingDisplay({ type: MultiplayerMatchType.RushBullet, profile: row as unknown as MultiplayerProfile, hideType: true }),
      sortable: true,
      allowOverflow: true,
    },
    {
      ...
      format: row => getProfileRatingDisplay({ type: MultiplayerMatchType.RushBlitz, profile: row as unknown as MultiplayerProfile, hideType: true }),
      sortable: true,
      allowOverflow: true,
    },
    {
      ...
      format: row => getProfileRatingDisplay({ type: MultiplayerMatchType.RushRapid, profile: row as unknown as MultiplayerProfile, hideType: true }),
      sortable: true,
      allowOverflow: true,
    },
    {
      ...
      format: row => getProfileRatingDisplay({ type: MultiplayerMatchType.RushClassical, profile: row as unknown as MultiplayerProfile, hideType: true }),
      sortable: true,
      allowOverflow: true,
    },
