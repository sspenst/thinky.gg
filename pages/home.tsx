          ...
          <div
            ...
            <div className="flex justify-center items-center h-full">
              <div className="text-white transition-blur duration-75">
                ...
                <div>
                  <a
                    className="inline-block px-5 py-3 mb-1 border-2 border-gray-200 bg-blue-100 text-gray-800 font-medium text-xl leading-snug rounded hover:ring-4 hover:ring-offset-1 hover:border-2 focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
