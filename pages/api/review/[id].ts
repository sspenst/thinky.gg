  ...
  if (req.method === 'POST') {
    ...
    try {
      ...
      await Promise.all([
        ...
        createNewReviewOnYourLevelNotification(level.userId._id, req.userId, level._id, score, !!trimmedText),
      ]);
    ...
    try {
      ...
      await Promise.all([
        ...
        queueRefreshIndexCalcs(new Types.ObjectId(id?.toString())),
        createNewReviewOnYourLevelNotification(level.userId, req.userId, level._id, score, !!trimmedText),
      ]);
